...
- [Motion](https://motion.dev) for section reveals; [GSAP](https://gsap.com) ScrollTrigger for the contact sign-off
...
- **Contact sign-off** — the nav brand mark flies to screen centre (GSAP), shatters into block glyphs and reassembles as the closing image; static and unanimated under `prefers-reduced-motion`
